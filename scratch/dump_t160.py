...
with open('scratch/t160_raw_dump.txt', 'w', encoding='utf-8') as f:
    f.write(f"Total questions in T160: {len(rows)}\n\n")
...
print(f"Dumped {len(rows)} questions to scratch/t160_raw_dump.txt")
