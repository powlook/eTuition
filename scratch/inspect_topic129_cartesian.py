...
print(f"Total questions in Topic 129: {len(rows)}")
...
with open('scratch/topic129_questions.json', 'w', encoding='utf-8') as f:
    json.dump(questions, f, indent=2, ensure_ascii=False)

with open('scratch/topic129_summary.txt', 'w', encoding='utf-8') as out:
    for q in questions:
...
print("Saved scratch/topic129_summary.txt")
