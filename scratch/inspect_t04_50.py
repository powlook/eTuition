...
for r in rows[4:]:
    ...
    if item_id.startswith('T04-'):
        t04_items.append(r)

print(f"Total T04 unique questions in Grade_9_Math_50_Unique_Questions.xlsx: {len(t04_items)}")

with open('scratch/t04_50_unique_detail.txt', 'w', encoding='utf-8') as f:
...
print("Saved scratch/t04_50_unique_detail.txt")
