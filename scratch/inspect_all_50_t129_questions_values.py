...
print(f"Loaded {len(items)} questions for Topic 129.")

with open('scratch/t129_all_50_values.txt', 'w', encoding='utf-8') as out:
    for item in items:
...
print("Wrote scratch/t129_all_50_values.txt")
