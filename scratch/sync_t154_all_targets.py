...
def sync_t154():
    with open('scratch/t154_50_built_questions.json', 'r', encoding='utf-8') as f:
        t154_questions = json.load(f)
        
    print(f"Loaded {len(t154_questions)} questions from scratch/t154_50_built_questions.json")
    ...
    q_map = {q["id"]: q for q in t154_questions}
        ...
        if isinstance(data, list):
            for item in data:
                ...
                if matched_id:
                    ...
                    item["options"] = [q["optA"], q["optB"], q["optC"], q["optD"]]
                    item["options_json"] = json.dumps([q["optA"], q["optB"], q["optC"], q["optD"]], ensure_ascii=False)
