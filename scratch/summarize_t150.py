...
with open("scratch/t150_raw_dump.json", "r", encoding="utf-8") as f:
    qs = json.load(f)
...
with open("scratch/t150_audit_summary.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("Saved scratch/t150_audit_summary.txt")
