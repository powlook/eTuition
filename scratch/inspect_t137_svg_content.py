...
svg_files = glob.glob('public/images/g8_t137_q*.svg')
print(f"Found {len(svg_files)} SVG files for Topic 137 in public/images")
...
with open('scratch/t137_svg_analysis.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, indent=2, ensure_ascii=False)

with open('scratch/t137_svg_summary.txt', 'w', encoding='utf-8') as out:
    for r in results:
...
print("Saved scratch/t137_svg_summary.txt")
